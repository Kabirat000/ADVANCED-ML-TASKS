...
#class to load validate and transform data
class LoadValidate:
    ...
    #method to validat missing value
    ...
    #method to replace missing values with null
    ...
    #method to achieve rejected files
    ...
    #method to move preprocessed files
    ...
    #method to validate predict data
